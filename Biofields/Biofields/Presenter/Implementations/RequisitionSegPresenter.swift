...
class RequisitionSegPresenter: BasePresenter {
    ...
    func requisitionSeg(id:Int){
        
        let authorization = "Bearer "+RealmManager.token()
        let url = String(format: Urls.API_REQUISITIONS_OPEN,id) as String
